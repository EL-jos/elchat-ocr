...
class ProspectingConfig extends Model
{
    ...
    protected $fillable = [
        'site_id', 'agent_id', 'icp', 'objective', 'limits', 'autonomy_mode',
        'schedule', 'crm_connector_slug', 'calendar_connector_slug', 'is_active',
    ];

    protected $casts = [
        'icp' => 'array', 'limits' => 'array', 'schedule' => 'array', 'is_active' => 'boolean',
    ];

    public function site(): BelongsTo { return $this->belongsTo(Site::class); }
    public function agent(): BelongsTo { return $this->belongsTo(McpAgent::class, 'agent_id'); }
    public function campaigns(): HasMany { return $this->hasMany(ProspectingCampaign::class, 'config_id'); }
