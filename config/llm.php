...
return [
    ...
    'tasks' => [
        ...
        'visitor_intelligence_analysis' => [
            'model' => env('LLM_VISITOR_INTELLIGENCE_MODEL', 'openai/gpt-4.1-mini'),
            'fallback_model' => env('LLM_VISITOR_INTELLIGENCE_FALLBACK_MODEL', 'deepseek/deepseek-v3.2'),
            'connect_timeout' => 10,
